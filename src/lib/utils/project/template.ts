// src/lib/utils/project/template.ts
...
export const STARTER_PROJECT_TITLE = 'demo-repo';
...
export const STARTER_PROJECT_ENTRY = VITE_REACT_TEMPLATE.entry;
export const STARTER_PROJECT_FILES = VITE_REACT_TEMPLATE.files;
