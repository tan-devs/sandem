declare const _default: import("convex/server").SchemaDefinition<{
    ...
    }, "required", "tokenIdentifier" | "username" | "isGuest" | "createdAt" | "lastSeen">, {
    ...
    }, "required", "ownerId" | "name" | "isPublic" | "room" | "entry" | "createdAt" | "updatedAt">, {
    ...
    nodes: import("convex/server").TableDefinition<import("convex/values").VObject<{
        ...
        parentId: import("convex/values").VId<import("convex/values").GenericId<"nodes"> | undefined, "optional">;
        createdAt: import("convex/values").VFloat64<number, "required">;
        updatedAt: import("convex/values").VFloat64<number, "required">;
    }, "required", "projectId" | "path" | "name" | "type" | "content" | "parentId" | "createdAt" | "updatedAt">, {
    ...
    }, "required", "ownerId" | "starterProjectSeeded" | "seededAt">, {
        by_owner: ["ownerId", "_creationTime"];
    }, {}, {}>;
}, true>;
